        ...
        <ul className="flex flex-col gap-3">
          <li>
            ...
            <span className="text-gray-500 text-lg">
              Readme.md (obligated before upload the template):{" "}
            </span>
            you must create a readme.md to show the people your template. If you
            use the command{" "}
            <span className="text-gray-500 text-lg">-init </span>
            it will generate a default readme.md.
          </li>
          <li className="w-3/5 flex flex-col gap-3">
            {" "}
            <span className="text-gray-500 text-lg">
              Command.json (obligated before upload the template):{" "}
            </span>
            This file is created so that when someone downloads your template,
            the console executes the necessary commands for your app or web. The
            command.json can include the description command;
            <ol className="ml-10 list-disc flex flex-col gap-3">
              <h4 className="text-gray-400">
                Types datas on the command.json:
              </h4>
              <li>
                <span className="text-gray-500">command:</span> is used to
                create the commands for you template. The command cd and code is
                generated by the code{" "}
                <span className="text-gray-500">-i or --init</span>
              </li>
              <li>
                <span className="text-gray-500">description:</span> is used to
                create a short description about your template.
              </li>
            </ol>
          </li>
        </ul>
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="w-3/5">
        ...
        command on the console. And before the upload you must include a
        command.json and README.md (readme must be in uppercase) file:
      </p>
      <Code
        text={`tempjs -u ${
